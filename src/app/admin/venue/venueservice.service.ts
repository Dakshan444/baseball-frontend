...
export class VenueserviceService {
    ...
    getVenue(): Observable<VenueModel[]> {
        return this.http.get<VenueModel[]>('https://localhost:44359/api/Venue/getAllVenue');
    }
    ...
    {
        return this.http.post<VenueModel>("https://localhost:44359/api/Venue/addVenue",body)
